import { SignupInput } from "@utkarsh038/medium-common";
    ...
    <div>
      <div>
        ...
        <input
          ...
          type={type || "text"}
          id="first_name"
          className="bg-gray-50 border border-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
